...
class SelectedMultiChipListWidget extends StatefulWidget {
  const SelectedMultiChipListWidget({
    Key? key,
  ...
  /// ensure that you wrap the [SelectedMultiChipListWidget]
  ...
  /// the [SelectedMultiChipListWidget], which is used in case of
  ...
  @override
  _SelectedMultiChipListWidgetState createState() =>
      _SelectedMultiChipListWidgetState();
}

class _SelectedMultiChipListWidgetState
    extends State<SelectedMultiChipListWidget> {
    ...
    return Wrap(
      children: List.generate(
        ...
        (index) => Padding(
          ...
          child: ChoiceChip(
            label: Text(widget.listOfChipNames[index].title,
                style: TextStyles.textViewMedium12.copyWith(color: secondry2)),
