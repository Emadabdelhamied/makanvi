...
import 'signup_buyer_page.dart';

class VerfiyPhoneNumberBuyerPage extends StatelessWidget {
  VerfiyPhoneNumberBuyerPage({super.key, this.isLogin = false, this.modeUser});
  final bool isLogin;
